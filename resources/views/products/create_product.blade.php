...
@section('content')
	...
	<div class="row">
		<div class="col-lg-12 col-md-12">
			<div class="card">
				<div class="card-body">
					<form action="{{route('products.store')}}" class="parsley-style-1" id="selectForm2" name="selectForm2" method="POST">
						@csrf
						<div class="">
							<div class="row mg-b-20">
								<div class="parsley-input col-md-6" id="fnWrapper">
									<label> {{ trans('message.Recipe_name') }}<span class="tx-danger">&nbsp; *</span></label>
									<input class="form-control" data-parsley-class-handler="#fnWrapper" name="product_name"   type="text">
								</div>
								<div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
									<label>{{ trans('message.description') }}<span class="tx-danger">&nbsp; *</span></label>
									<textarea style="height: 40px" class="form-control" data-parsley-class-handler="#lnWrapper" name="product_desc"   type="text"></textarea>
